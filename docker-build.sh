...
then
	...
	docker run --rm -v $(pwd):/project $TAG_NAME /bin/bash -c "git config --global --add safe.directory /project ; cd /project ; ./ci/gitlab-ci/commons/make-appimage.sh ; chmod -R 777 build/"
fi
