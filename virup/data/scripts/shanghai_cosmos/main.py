...
# Intro
    ...
    Transition(Scene(SceneSpatialData(Universe, 'Solar System', 'Earth', 30000000),
        SceneTemporalData(1.0, startdt), SceneUI({"Hipparcos":0.1, "PlanetsLabels":1.0})), 10.0, "Earth 地球", "earth"),
    # Debris
    Transition(Scene(SceneSpatialData(Universe, 'Solar System', 'Earth', 40000000),
          SceneTemporalData(1000.0), SceneUI({"Gaia":1.0, "Hipparcos":0.1, "Debris":1.0})), 10.0, "Debris 太空垃圾", "earth"),
    # Phobos
    Transition(Scene(SceneSpatialData(Universe, 'Solar System', 'Phobos', 30000),
       ...
       SceneCameraData(), SceneToneMappingData(0.5)), 10.0, 'Phobos 火卫一', 'phobos'),
    # Jupiter
    Transition(Scene(SceneSpatialData(Universe, 'Solar System', 'Jupiter', 300000000),
       ...
       SceneCameraData(), SceneToneMappingData(1.0)), 10.0, 'Jupiter 木星', 'jupiter'),
    # Saturn
    Transition(Scene(SceneSpatialData(Universe, 'Solar System', 'Saturn', 300000000),
       ...
       SceneCameraData(), SceneToneMappingData(3.0)), 10.0, 'Saturn 土星', 'saturn'),
    #Solar System
    Transition(Scene(SceneSpatialData(Universe, 'Solar System', 'Sun', 1.65181e+12),
      SceneTemporalData(10000000.0), SceneUI({"Hipparcos":0.1, "Constellations":0.0, "Orbits":1.0, "PlanetsLabels":1.0, "Asteroids":1.0, "Constellations":1.0})), 10.0, "Solar System 太阳系"),
    # Milky Way
    Transition(Scene(SceneSpatialData(Universe, 6.171e+20),#, Vector3(-0.43, -8.24, -0.81)),
          SceneTemporalData(), SceneUI({"LG Dwarves":5.0, "Volumetric AGORA":1.0, "M33":1.0, "Andromeda":1.0})), 10.0, "Milky Way 银河系"),
    # Illustris
    ...
    Transition(Scene(SceneSpatialData(Universe, 1.0e+26),
          SceneTemporalData(), SceneUI({"SDSS":1.0, "IllustrisTNG":1.0, "LG Dwarves":5.0, "Volumetric AGORA":1.0, "M33":1.0, "Andromeda":1.0})), 10.0, "SDSS 史隆數位巡天"),
    #CMB
    Transition(Scene(SceneSpatialData(Universe, 1.0e+27),
          SceneTemporalData(), SceneUI({"SDSS":1.0, "IllustrisTNG":1.0, "CMB":1.0, "LG Dwarves":5.0, "Volumetric AGORA":1.0, "M33":1.0, "Andromeda":1.0})), 10.0, "CMB 宇宙微波背景"),
]
