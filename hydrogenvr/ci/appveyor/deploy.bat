...
set EXE_PATH=%HVR_DIRECTORY%\innosetup\Output\%EXE_FILE%
...
echo If any error occured, please read https://gitlab.com/Dexter9313/%HVR_DIRECTORY%/-/wikis/tutorials/1-general-topics/9-continuous-integration for more details.
