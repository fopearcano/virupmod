call %APPVEYOR_BUILD_FOLDER%\hydrogenvr\ci\appveyor\install_scripts\openvr.bat
::call %APPVEYOR_BUILD_FOLDER%\hydrogenvr\ci\appveyor\install_scripts\leap.bat
